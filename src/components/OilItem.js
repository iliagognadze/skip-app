...
const OilItem = (props) => {
    ...
    return (
        <div className="drop-shadow-lg flex md:flex-col p-4 h-fit rounded bg-white md:hover:bg-gray-200 transition cursor-pointer" onClick={() => selectionHandler(item)}>
            ...
            <div className="flex-col justify-between">
                ...
                <div className="flex justify-between items-center">
                    <button onClick={(e) => props.onDetails(e, item)} className="bg-primary text-white text-xs p-1 rounded pt-2">დეტალები</button>
                    <p>{item.price}₾</p>
                </div>
            </div>
        </div>
